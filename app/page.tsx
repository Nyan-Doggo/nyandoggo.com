  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto mt-12">
      ...
      <div className="grid grid-cols-3 gap-8 mb-12">
        <img src="/moomin/1.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
        ...
        <img src="/moomin/2.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
        ...
        <img src="/moomin/4.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
        <div className="flex hover:bg-gray-600 hover:text-green-100 transition duration-700 px-6">
          <p className="m-auto text-lg">
            I want to reach out, but somehow i think that might just make everything worse.
          </p>
        </div>
        <img src="/moomin/5.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
        ...
        <img src="/moomin/7.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
        <div className="flex hover:bg-gray-600 hover:text-green-100 transition duration-700 px-6">
          <p className="m-auto text-lg">
            Wake me up in an hour or so, i... i just need a quick break
          </p>
        </div>
        <img src="/moomin/8.jpg" className="object-cover max-h-[400px] w-full filter grayscale transition hover:grayscale-0 duration-700" />
      </div>
